...
public class EventAdapter extends RecyclerView.Adapter<EventAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        PicassoClient.downloadImage(ctx, listEvent.get(position).getImg(), holder.ivImage);

        holder.ivImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dialogDetail.show();
                dialog_tvUsername.setText(listEvent.get(position).getUsername());
                dialog_tvDate.setText(listEvent.get(position).getDate());
                dialog_tvTitle.setText(listEvent.get(position).getProductname());
                dialog_tvDesc.setText(listEvent.get(position).getDescription());
                dialog_tvPrice.setText(listEvent.get(position).getPrice());
                dialog_tvType.setText(listEvent.get(position).getType());
                dialog_etFrom.setText("");
                dialog_etTo.setText("");
                PicassoClient.downloadImage(ctx, listEvent.get(position).getImg(), dialog_ivImage);
