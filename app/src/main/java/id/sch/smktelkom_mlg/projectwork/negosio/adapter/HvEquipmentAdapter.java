...
public class HvEquipmentAdapter extends RecyclerView.Adapter<HvEquipmentAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        PicassoClient.downloadImage(ctx, listHvEquipm.get(position).getImg(), holder.ivImage);

        holder.ivImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dialogDetail.show();
                dialog_tvUsername.setText(listHvEquipm.get(position).getUsername());
                dialog_tvDate.setText(listHvEquipm.get(position).getDate());
                dialog_tvTitle.setText(listHvEquipm.get(position).getProductname());
                dialog_tvDesc.setText(listHvEquipm.get(position).getDescription());
                dialog_tvPrice.setText(listHvEquipm.get(position).getPrice());
                dialog_tvType.setText(listHvEquipm.get(position).getType());
                dialog_etFrom.setText("");
                dialog_etTo.setText("");
                PicassoClient.downloadImage(ctx, listHvEquipm.get(position).getImg(), dialog_ivImage);
